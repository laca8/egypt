...
const SecondaryStudents = () => {
  ...
  const API_URI = "/api/edu/secondary/stu/export/csv";
  ...
  const handleSubmit = async (e) => {
    ...
    setLoad(true);
    try {
      const response = await fetch("/api/edu/secondary/stu", {
        method: "POST",
        body: formData,
      });
...
export default SecondaryStudents;
