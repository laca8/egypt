...
const CommSchool = () => {
  ...
  const API_URI = "/api/edu/community/school/export/csv";
  ...
  const handleSubmit = async (e) => {
    ...
    setLoad(true);
    try {
      const response = await fetch("/api/edu/community/school", {
        method: "POST",
        body: formData,
      });
