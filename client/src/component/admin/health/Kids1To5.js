...
const Kids1To5 = () => {
  ...
  const API_URI = "/api/health/death/kids/from1to5years/export/csv";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/api/health/death/kids/from1to5years",
        {
          method: "POST",
          body: formData,
        }
      ...
      {load ? (
        ...
        >
          ...
          <div style={{ width: "100%" }}>
            ...
            >
              <a
                href={`${API_CSV}/health/kids_1to5/${json}`}
                download={json}
                target="_parent"
