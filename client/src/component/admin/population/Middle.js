...
const Middle = () => {
  ...
  const API_URI = "/api/population/middle/export/csv";
  ...
  const handleSubmit = async (e) => {
    ...
    setLoad(true);
    try {
      const response = await fetch("/api/population/middle", {
        method: "POST",
        body: formData,
      });
  ...
  const handleExport = async () => {
    try {
      ...
      a.href = url;
      a.download = "عدد_السكان_منتصف_العام.csv";
