const Indus = require("../../../models/edu/teachers/Indus");
var fs = require("fs");
...
const getTeachers = async (req, res) => {
  try {
    const teachers = await Indus.aggregate([
      {
...
const importData = async (req, res) => {
  try {
    ...
    await Indus.insertMany(result["undefined-0"]);
...
const exportToCsv = async (req, res) => {
  try {
    ...
    mongoXlsx.mongoData2Xlsx(
      ...
      model,
      {
        fileName: "عدد_المدرسين_ثانوي_صناعي" + Date.now() + ".csv",
