const Special = require("../../../models/edu/teachers/Special");
var fs = require("fs");
...
const getTeachers = async (req, res) => {
  try {
    const teachers = await Special.aggregate([
      {
...
const importData = async (req, res) => {
  try {
    ...
    await Special.insertMany(result["undefined-0"]);
...
const exportToCsv = async (req, res) => {
  try {
    ...
    mongoXlsx.mongoData2Xlsx(
      ...
      model,
      {
        fileName: "عدد_المدرسين_التربية_الخاصة" + Date.now() + ".csv",
