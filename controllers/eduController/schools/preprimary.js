const PrePrimary = require("../../../models/edu/schools/Pre-Primary");
...
const getSchools = async (req, res) => {
  try {
    const schools = await PrePrimary.aggregate([
      {
  ...
  try {
    ...
    fileStream
      ...
      .on("end", async () => {
        ...
        const insertedData = await PrePrimary.insertMany(results);
...
const exportToCsv = async (req, res) => {
  try {
    ...
    // Write to file
    const filename = "PrePrimary" + Date.now() + ".csv";
