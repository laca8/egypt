const Secondary = require("../../../models/edu/schools/Secondary");
...
const getSchools = async (req, res) => {
  try {
    const schools = await Secondary.aggregate([
      {
...
const importData = async (req, res) => {
  try {
    ...
    await Secondary.insertMany(result["undefined-0"]);
...
const exportToCsv = async (req, res) => {
  try {
    ...
    mongoXlsx.mongoData2Xlsx(
      ...
      model,
      {
        fileName: "عدد_المدارس_المرحلة_الاعدادية" + Date.now() + ".csv",
