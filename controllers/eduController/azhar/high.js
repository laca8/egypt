const HighStudent = require("../../../models/edu/azhar/HighStudent");
var fs = require("fs");
...
const importData = async (req, res) => {
  try {
    ...
    // await HighStudent.insertMany(result["undefined-0"]);
...
const exportToCsv = async (req, res) => {
  try {
    ...
    //   model,
    //   {
    //     fileName: "عدد_الطلاب_المرحلة_الثانوية" + Date.now() + ".csv",
    //     path: "./public/azhar/high",
    //   },
    //   function (err, data) {
    ...
    // Write to file
    const filename = "high" + Date.now() + ".csv";
