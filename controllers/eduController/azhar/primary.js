...
const importData = async (req, res) => {
  try {
    ...
    await PrimaryStudents.insertMany(result["undefined-0"]);
...
const exportToCsv = async (req, res) => {
  try {
    ...
    const data = await PrimaryStudents.find({});
    //console.log(data);
    ...
    mongoXlsx.mongoData2Xlsx(
      ...
      model,
      {
        fileName: "عدد_الطلاب_الابتدائي_ازهر" + Date.now() + ".csv",
        path: "./public/azhar/primary",
      },
      function (err, data) {
